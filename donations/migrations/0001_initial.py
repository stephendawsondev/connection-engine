...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('os_project', '0004_milestone_milestonegoal_projectmentor'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='donations', to='os_project.project')),
                ('sponsored_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='sponsorships', to='user_profile.womenintech')),
